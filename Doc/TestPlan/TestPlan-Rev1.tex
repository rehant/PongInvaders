...
when respectively checked. %% typo here
...
Input: JUnit test cases  %% "JUnit" not "J-Unit"
...
How test will be performed: The game will be in an active state and the player wil be set to %% typo
